...
interface SupabaseEventRegistrationProps {
  onBack: () => void
}
...
const SupabaseEventRegistration: React.FC<SupabaseEventRegistrationProps> = ({ onBack }) => {
  const { user } = useAuth()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const eventRegistration: Omit<EventRegistration, 'id' | 'created_at'> = {
        user_id: user.id,
        name: formData.name,
...
export default SupabaseEventRegistration